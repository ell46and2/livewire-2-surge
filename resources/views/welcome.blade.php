@extends('layouts.app')
<div class="relative flex min-h-screen justify-center bg-gray-100 py-4 items-top dark:bg-gray-900 sm:items-center sm:pt-0">
    @if (Route::has('login'))
        <div class="fixed top-0 right-0 hidden px-6 py-4 sm:block">
            @auth
                <a
                    href="{{ url('/home') }}"
                    class="text-sm text-gray-700 underline dark:text-gray-500">Home</a>
            @else
                <a
                    href="{{ route('login') }}"
                    ...
                    <div class="ml-12">
                        <div class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            Laravel's robust library of first-party tools and libraries, such as <a
                                ...
                                class="underline">Envoyer</a> help you take your projects to the next level. Pair them
                            with powerful open source libraries like <a
